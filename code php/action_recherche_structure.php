...
if($total) {
    ...
    echo '<td bgcolor="#006498"><font color="white"><b><u>Date Parution Journal officiel</u></b></font></td>';
...
?>
    <form action="action_recherche_structure_personne.php" method="get">
        entrer l'idStructure correspondant :<input type="number" name="idStructure" required><br><br>
